...
\section{Projetos}
    ...
    \resumeSubHeadingListStart
      \resumeProjectHeading
          {\textbf{Projeto} $|$ \emph{TypeScript, Nest, Postgre, React, Docker}}{Janeiro 2025}
          \resumeItemListStart
            \resumeItem{}
            \resumeItem{}
            \resumeItem{}
          ...
          \vspace{-13pt}
      \resumeProjectHeading
          {\textbf{??} $|$ \emph{Python, Streamlit, Postgre, Docker}}{Novembro 2024}
          \resumeItemListStart
            \resumeItem{}
            \resumeItem{}
            \resumeItem{}
...
\section{Programming Skills}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
     \textbf{Languages}{: Python, TypeScript, JavaScript, \texttt{C\#}, SQL, React} \\
     \textbf{Developer Tools}{: VS Code, GIT, Docker, Google Cloud Platform, AWS} \\
     \textbf{Technologies/Frameworks}{: Linux, FastAPI, Nest, NodeJS, ASP.NET, RabbitMQ} \\
    }}
 \end{itemize}
 \vspace{-16pt}
\end{document}
